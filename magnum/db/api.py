...
class Connection(object):
    ...
    @abc.abstractmethod
    def get_federation_count_all(self, context, filters=None):
        """Get count of matching federations.

        :param context: The security context
        :param filters: Filters to apply. Defaults to None.
        :returns: Count of matching federations.
        """
        ...
        :param values: A dict containing several items used to identify
                       ...
                       ::

                        {
                         'uuid': uuidutils.generate_uuid(),
                         'name': 'example',
                         'master_id': '91c8dd07-14a2-4fd8-b084-915fa53552fd',
